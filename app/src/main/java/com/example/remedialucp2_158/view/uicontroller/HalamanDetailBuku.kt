...
import com.example.remedialucp2_158.viewmodel.DetailViewModel.DetailBukuUiState
...
import com.example.remedialucp2_158.viewmodel.toBuku
...
fun DetailBukuScreen(
    ...
    Scaffold(
        ...
        floatingActionButton = {
            ...
            FloatingActionButton(
                onClick = {
                    navigateToEditItem(uiState.value.detailBuku.id)
                },
...
fun DetailDataBuku(
    ...
    Card(
        ...
        Column(
            ...
            BarisDetailData(
                labelResID = R.string.isbn1,
                itemDetail = buku.isbn,
                modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen
                            .padding_medium
            ...
            BarisDetailData(
                labelResID = R.string.tahun1,
                itemDetail = buku.tahun,
                modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen
                            .padding_medium
